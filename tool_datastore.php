...
$string['columnsiteinfoactiveusers'] = 'Number of unique users who logged in during the last month';
$string['columnsiteinfousers'] = 'Total number of unique user accounts';
$string['columnsiteinfowpactiveusersyear'] = 'Number of unique users who logged in during the last 12 months';
...
$string['entitysiteinfo'] = 'Data store site information';
...
$string['reportsiteinfo'] = 'Historical site information';
$string['snapshotdate'] = 'Snapshot date';
$string['tasksiteinfo'] = 'Collect and store site information';
