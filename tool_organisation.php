...
$string['organisation:allocateteammemberstolearning'] = 'Allocate team members to learning';
$string['organisation:allocateteammemberstolearning_help'] = 'A person with this permission can allocate team members to learning entities, such as courses, programs or certifications.';
...
$string['organisation:receivenotifications'] = 'Receive notifications';
$string['organisation:receivenotifications_help'] = 'A person with this permission receives notifications that have been specifically configured to be sent to them (e.g., via Dynamic Rules).';
$string['organisation:viewextendedteamreports'] = 'View extended team reports';
$string['organisation:viewextendedteamreports_help'] = 'A person with this permission can view detailed reports on the learning progress of anyone who reports to them.';
...
$string['toomanydepartmentstoshow'] = 'Too many departments to show.';
$string['toomanyparentstoshow'] = 'Too many parents to show.';
$string['toomanypositionstoshow'] = 'Too many positions to show.';
