...
$string['cannotenablerule'] = 'Cannot enable rule \'{$a}\' unless it has conditions and actions, is not broken and is not archived';
...
$string['conditionisbroken'] = 'This condition configuration is broken.';
...
$string['enablehelp_help'] = 'All rules require at least one condition and one action to be enabled.';
...
$string['outcomeisbroken'] = 'This action configuration is broken.';
