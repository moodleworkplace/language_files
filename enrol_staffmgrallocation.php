...
$string['reg_wpstaffmgrallocationenrolledusers'] = 'Number of users enrolled in courses through the enrol_wpstaffmgrallocation plugin ({$a})';
$string['reg_wpstaffmgrallocationinstances'] = 'Number of instances of enrol_wpstaffmgrallocation plugin ({$a})';
