...
$string['custompage:viewall'] = 'View all custom pages';
...
$string['newpageglobaldescription'] = 'This page will be available in all tenants, including the current one';
$string['newpagelocal'] = 'New local page';
$string['newpagelocaldescription'] = 'This page will be available only in the current tenant';
$string['newpagestart'] = 'New start page';
$string['newpagestartdescription'] = 'This page will be available to be set as the start page by all users in all tenants';
