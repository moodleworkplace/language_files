...
$string['sharedspaceconfirmationtext'] = 'Shared space is a place for you to share entities and content among all tenants. Everything you create in this space will instantly become available for users in any tenants. This action can\'t be undone. <br/><br/> Do you want to enable Shared space ?';
$string['sharedspaceenabledmessage'] = 'Shared space was enabled successfully. Use the tenant switch to access it.';
