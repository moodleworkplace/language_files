...
$string['showinloginselector_help'] = 'By enabling this option, this tenant will be listed on the login page of every tenant as an alternative login page.';
...
$string['tenantavailability'] = 'Tenant availability';
