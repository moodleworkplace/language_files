<?php
$string['accountalreadyconfirmedinfo'] = '{$a} account(s) skipped as already confirmed';
$string['accountconfirmedfail'] = '{$a} account(s) not found or could not be confirmed';
$string['accountconfirmedsuccess'] = '{$a} account(s) confirmed';
$string['activateusers'] = 'Activate users';
$string['activateusersintotenant'] = 'Activate users into tenant...';
$string['activateusersintotenantdescription'] = 'Please select the tenant you want users to be allocated to. All users will keep their previous role in the new selected tenant, including tenant administrators.';
$string['activateusersintotenantfail'] = '{$a->users} user(s) could not be allocated to \'{$a->tenant}\'!';
$string['activateusersintotenantsuccess'] = 'All users are now active and allocated to \'{$a->tenant}\'! <a href="{$a->link}">Manage users</a>';
$string['activateusersintotenantsuccesswithfails'] = '{$a->users} user(s) have been allocated to \'{$a->tenant}\' and {$a->unsuspendedusers} user(s) are now active! <a href="{$a->link}">Manage users</a>';
$string['activetenants'] = 'Active tenants';
$string['activeusers'] = 'Activate user accounts';
...
$string['allsitescount'] = 'All sites ({$a})';
...
$string['assignrolesglobally'] = 'Assign roles globally to site users';
...
$string['confirmactivateuser'] = 'Are you sure you want to activate this user?';
$string['confirmactivateusers'] = 'Are you sure you want to activate the selected users?';
$string['confirmallocateusers'] = 'Please select the tenant you want users to be allocated to.<br><br>All users will keep their roles except for the tenant administrator role. Please note that some users may still have roles assigned to them in the context of the previous tenant\'s category.';
...
$string['confirmarchivetenantwithoutusers'] = 'Are you sure you want to archive the tenant \'{$a}\'?';
$string['confirmarchivetenantwithusers'] = 'Are you sure you want to archive the tenant \'{$a->tenant}\'? {$a->users} user(s) allocated to this tenant will be suspended.';
$string['confirmassigntenantadmins'] = 'Are you sure you want to add the selected users to the list of tenant administrators?';
$string['confirmdeletetenant'] = 'Are you sure you want to permanently delete the tenant \'{$a}\'? All users allocated to this tenant will be deleted.';
...
$string['confirmrestoretenant'] = 'Are you sure you want to restore the tenant \'{$a}\'? All users allocated to this tenant will become active.';
...
$string['crosstenantpermissions'] = 'Cross-tenant permissions';
...
$string['description_help'] = 'Describe this tenant in one or two short sentences. Using images or long text is not recommended.';
...
$string['editsortorder'] = 'Edit sort order';
...
$string['errorcantupdatesortorder'] = 'Can\'t update sort order.';
...
$string['globaluserroles'] = 'Global user roles';
...
$string['nositesfound'] = 'No sites found';
...
$string['overridesetting_allowed'] = 'Use tenant overrides. Editing allowed at tenant level';
$string['overridesetting_alloweddescription'] = 'Tenant level changes to this setting will be used when it is overridden. Both site admins and users with permissions can set overrides.';
...
$string['overridesetting_limited'] = 'Use tenant overrides. Editing restricted';
$string['overridesetting_limiteddescription'] = 'Tenant level changes to this setting will be used when it is overridden. Only site admins can set overrides.';
...
$string['reg_wpmultitenantsettingseditingrestricted'] = 'Number of setting values that have the "Multi-tenant behaviour for this setting" setting set to "Use tenant overrides. Editing restricted" ({$a})';
$string['reg_wpmultitenantsettingsglobal'] = 'Number of setting values that have the "Multi-tenant behaviour for this setting" setting set to "Use global site setting for all tenants" ({$a})';
...
$string['searchsites'] = 'Search site by name...';
...
$string['settingoverridenglobal'] = 'The global site setting is now enforced across all tenants. Tenant level overrides have been disabled.';
$string['settingoverridenrestricted'] = 'Tenant specific overrides are now taking precedence over site level configuration. Only site admins can set overrides.';
...
$string['settingoverridentenantlevel'] = 'Tenant specific overrides are now taking precedence over site level configuration. Site admins and users with permissions can set overrides.';
...
$string['shownintheloginselector'] = 'Shown in the login selector';
...
$string['sitesfilteredcount'] = 'Sites ({$a->shown} of {$a->total})';
...
$string['sortorder_help'] = 'Sort order affects tenants display order on the login page. It applies only to tenants with \'Show this tenant in the login selector\' enabled.';
...
$string['tenant:overridesettings'] = 'Edit tenant settings';
...
$string['tenantarchivedsuccess'] = 'Tenant \'{$a}\' has been archived! All allocated users have been suspended.';
...
$string['tenantdeleted'] = 'Tenant \'{$a}\' has been deleted.';
$string['tenantdetails'] = 'Details';
$string['tenanthascategory'] = 'Tenant has category';
...
$string['tenantrestoredsuccess'] = 'Tenant \'{$a->tenant}\' has been restored! All users allocated to this tenant are now active. <a href="{$a->link}">Manage users</a>.';
...
$string['unrecognisedaction'] = 'Unrecognised action';
$string['useractivatedsuccess'] = 'User activated successfully';
...
$string['userrolesincategory'] = 'User roles in course category: {$a}';
$string['usersactivatedfail'] = '{$a} user(s) not found or could not be activated';
$string['usersactivatedsuccess'] = '{$a} user(s) activated';
