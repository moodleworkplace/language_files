...
$string['blockmyoverviewmobileonly'] = 'Display only in mobile app';
$string['blockmyoverviewmobileonly_help'] = 'Display this block only in the mobile app, hiding it from everyone in the browser version. The Learning tab on the dashboard already displays all enrolled courses.';
