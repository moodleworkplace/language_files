...
$string['blockmyoverviewmobileonly'] = 'Display the "Course overview" block only in the mobile app';
$string['blockmyoverviewmobileonly_help'] = 'Display the "Course overview" block only in the mobile app, hiding it from everyone in the browser version. Highly recommended when the "Enable Learning tab on the Dashboard" option is checked.';
$string['blockmyoverviewmobileonlyalert'] = 'Content of this block will be displayed in the mobile app only.';
