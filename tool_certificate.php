...
$string['certificate:verify'] = 'Vefiry any certificates within current tenant';
$string['certificate:verifyforalltenants'] = 'Verify any certificate on the site for all tenants';
$string['certificate:viewallcertificates'] = 'View all certificates templates and issues for the current tenant';
...
$string['elements_help'] = 'This is the list of elements that will be displayed on the certificate. Note that the elements are rendered in this order. The order can be changed by using the arrows next to each element.';
$string['elementwidth'] = 'Width, mm';
...
$string['leftmargin'] = 'Left margin, mm';
...
$string['page'] = 'Page {$a}';
$string['pageheight'] = 'Page height, mm';
...
$string['pagewidth'] = 'Page width, mm';
...
$string['templatenameexists'] = 'The template name is currently in use. Please choose a different name.';
...
$string['verifyallcertificates_desc'] = 'When this setting is enabled any person (including users not logged in) can visit the link \'{$a}\' in order to verify any certificate on the site, rather than having to go to the verification link for each certificate. Note that this only applies to certificates where \'Allow anyone to verify a certificate\' is set to \'Yes\' in the certificate settings.';
